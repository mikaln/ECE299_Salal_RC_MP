...
class screen:
    ...
    def __init__(self):
        ...
        self.alarmMinuteMenuOptions = {
            "Back": [self.alarmMenuOptions["Alarm minute"][0], self.goto_alarm_menu]
        }
        self.alarmHourMenuOptions = {
            "Back": [self.alarmMenuOptions["Alarm Hour"][0], self.goto_alarm_menu]
        }
        self.setSnoozeMenuOptions = {
            "Back" : [self.alarmMenuOptions["Snooze Duration"][0], self.goto_alarm_menu]
        }
        self.setSnoozeMenu = Menu("Snooze Menu", self.setSnoozeMenuOptions, self.drawSetSnoozeMenu)
    ...
    def goto_alarm_menu(self):
        ...
        Cursor.Total_Numof_settings = len(self.AlarmMenu.options)
    ...
    def drawAlarmMenu(self):
        ...
        for option in alarm_options:
            if Cursor.cursor_value == self.AlarmMenu[option][0]:
        ...
        x_val = 20
        y_val = y_val - 2*dy
        if Cursor.cursor_value == self.AlarmMenu["Toggle Alarm"][0]:
    ...
    def drawMainControls(self):
        ...
        al_str = "Alarm at: "+self.alarm_string + "AM"
